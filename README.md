...
- Replace `dianakerekesha` with your Github username in the [DEMO LINK](https://dianakerekesha.github.io/react_goods-selector-js/) and add it to the PR description.
