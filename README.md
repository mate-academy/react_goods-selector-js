...
- Replace `MarianaKlochnyk` with your Github username in the [DEMO LINK](https://MarianaKlochnyk.github.io/react_goods-selector-js/) and add it to the PR description.
