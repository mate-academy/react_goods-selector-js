...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://allgrain464-ops.github.io/react_goods-selector-js/) and add it to the PR description.
