...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://veronica-shyian.github.io/react_goods-selector-js/) and add it to the PR description.
