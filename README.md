...
- Replace `<your_account>` with your Github username in the [DEMO LINK](https://TarasPidkuimukha.github.io/react_goods-selector-js/) and add it to the PR description.
